...
/**
 * Definicion de las constatntes BASE_URL y BASE_URI para manejo de la ruta base de la aplicación
 * Definicion de la constante BASE_STATIC para la ruta de los archivos estaticos ASSETTS de la aplicación
 */
